<template functional>
  <div>
    ...
    <div v-if="props.name === 'news'">
      <svg :class="[props.width, props.height]" class="fill-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
